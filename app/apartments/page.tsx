...
const Apartments = ({
  ...
  const apartmentsFilter = apartments.filter((apartment) => {
  ...
  return (
    <div className='min-h-screen grid grid-cols-3 gap-4 px-24 py-12 place-items-center max-lg:grid-cols-2 max-sm:grid-cols-1 max-lg:px-4 relative '>
